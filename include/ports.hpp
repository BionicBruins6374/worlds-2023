...
constexpr int8_t LEFT_BACK_MOTOR = 5;
constexpr int8_t RIGHT_BACK_MOTOR = 4;
constexpr int8_t LEFT_FRONT_MOTOR = 7;
constexpr int8_t RIGHT_FRONT_MOTOR = 2; // under motor is front
...
constexpr int8_t INERTIAL_1 = 1;
constexpr int8_t INERTIAL_2 = 9; 
